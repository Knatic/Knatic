const data = [
    ...
    {
      id: 5,
      question: "Is hosting and domain registration inclusive in your projects?",
    ...
    {
      id: 4,
      question: "How much time do you spend  for an average website or app?",
      answer: "Once again, this depends. But my prices are affordable so you're good."
    },
    {
      id: 3,
      question: "What's your development  cost usually?",
      answer: "Development cost is divided into 3. An initial 30% upfront idea to get me started once all the details of the project is set, 40% once the project is completed, and 30% once the project is delivered."
    },
    {
      id: 6,
